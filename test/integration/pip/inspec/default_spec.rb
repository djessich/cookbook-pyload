...
case os.family
when 'debian'
  packages = %w(python3 python3-dev python3-venv curl libcurl4-openssl-dev openssl libssl-dev sqlite3 tesseract-ocr tesseract-ocr-eng)
when 'fedora'
...
when 'suse'
  packages = %w(python3 python3-devel curl libcurl-devel openssl libopenssl-devel sqlite3 tesseract-ocr)
end
