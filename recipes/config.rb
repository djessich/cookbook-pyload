...
template "#{node['pyload']['config_dir']}/pyload.conf" do
  ...
  variables(
    ...
    permission_user: node['pyload']['permission']['user'].nil? ? node['pyload']['user'] : node['pyload']['permission']['user'],
    permission_group: node['pyload']['permission']['group'].nil? ? node['pyload']['group'] : node['pyload']['permission']['group'],
    ...
    permission_change_user: node['pyload']['permission']['change_user'].to_s.capitalize,
    permission_change_group: node['pyload']['permission']['change_group'].to_s.capitalize,
    ...
    ssl_cert: "#{node['pyload']['ssl']['certificate_path']}/#{node['pyload']['ssl']['certificate']}",
    ssl_key: "#{node['pyload']['ssl']['certificate_key_path']}/#{node['pyload']['ssl']['certificate_key']}",
